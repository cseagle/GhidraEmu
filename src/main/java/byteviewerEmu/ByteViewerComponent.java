...
//        scrollPane.getViewport().removeChangeListener(this);
    ...
    private void initialize() {
        ...
        currentCursorColor = ByteViewerComponentProviderEmu.DEFAULT_CURRENT_CURSOR_COLOR;
        setNonFocusCursorColor(ByteViewerComponentProviderEmu.DEFAULT_NONFOCUS_CURSOR_COLOR);
        setFocusedCursorColor(currentCursorColor);
