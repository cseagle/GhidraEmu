...
//    private ByteViewerPlugin plugin;
     ...
     * Constructor
     */
    ByteViewerPanel(ByteViewerComponentProviderEmu provider) {
        super();
        this.provider = provider;
        bytesPerLine = ByteViewerComponentProviderEmu.DEFAULT_BYTES_PER_LINE;
        viewList = new ArrayList<>();
        indexMap = new IndexMap();
        create();
        editColor = ByteViewerComponentProviderEmu.DEFAULT_EDIT_COLOR;
    }
        ...
        try {
            ...
            if (blockSet != null) {
                ...
                if (blocks.length > 0) {
                    ...
                    indexPanelWidth = getIndexPanelWidth(blocks) + 20;
...
//        }
    ...
    void setFontMetrics(FontMetrics fm) {
        ...
        indexPanelWidth =
            ByteViewerComponentProviderEmu.DEFAULT_NUMBER_OF_CHARS * charWidth + (2 * charWidth);
        if (blocks != null) {
    ...
    private void create() {
        ...
        fm = getFontMetrics(ByteViewerComponentProviderEmu.DEFAULT_FONT);
        ...
        columnHeader.addColumn(ByteViewerComponentProviderEmu.DEFAULT_INDEX_NAME, indexPanel);
        ...
        help.registerHelp(this, new HelpLocation("ByteViewer", "ByteViewer"));
    }
