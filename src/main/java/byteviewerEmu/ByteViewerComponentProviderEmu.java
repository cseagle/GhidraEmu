...
public abstract class ByteViewerComponentProviderEmu extends ComponentProviderAdapter
    ...
    protected final ByteViewerPluginEmu plugin;

    protected SwingUpdateManager updateManager;

    private Map<String, Class<? extends DataFormatModel>> dataFormatModelClassMap;

    protected ByteViewerComponentProviderEmu(PluginTool tool, ByteViewerPluginEmu plugin, String name,
            Class<?> contextType) {
